const Statistic = ({ title, subTitle, leftSide, rightSide, requestHref }) => (
  <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20" id="about">
    ...
    <p className="mx-auto mb-4 text-gray-600 sm:text-center lg:max-w-2xl lg:mb-6 md:px-16 font-bold">
      <a target="_blank" className="text-sky-700 cursor-pointer  hover:underline decoration-2" href={requestHref} rel="noreferrer">Join INFLYTE</a> now to gain an advantage in the upcoming era of decentralized influence marketing.
    </p>
  </div>
);
