const Features = ({ data }) => (
  <section className="px-4 py-20 mx-auto max-w-7xl" id="features">
    ...
    <p className="mb-16 text-lg text-black-500">The list of unique features of our project</p>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-16 lg:gap-x-24 gap-y-20">
      {data.map((feature) => (
        <div key={feature.title} className="drop-shadow-lg p-5 bg-white rounded overflow-hidden">
