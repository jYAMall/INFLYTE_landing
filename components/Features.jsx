const Features = () => (
  <section className="px-4 py-20 mx-auto max-w-7xl">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-16 lg:gap-x-24 gap-y-20">
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        ...
        <p className="text-sm text-gray-500">Hand crafted dashboards for everything from Recurring Revenue to
          Customer Churn.
        </p>
      </div>
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        ...
        <p className="text-sm text-gray-500">Your central hub that helps you see, and react to, absolutely
          everything that’s happening.
        </p>
      </div>
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        <div
          className="flex items-center justify-center w-8 h-8 mb-4 text-yellow-600 bg-yellow-100 rounded-full"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"
            aria-hidden="true"
          >
        ...
        <p className="text-sm text-gray-500">Stay informed with daily, weekly, or monthly reports on all your
          insights data.
        </p>
      </div>
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        ...
        <p className="text-sm text-gray-500">Our forecasting is your magical crystal ball that helps you predict
          and plan for the future.
        </p>
      </div>
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        <div
          className="flex items-center justify-center w-8 h-8 mb-4 text-purple-600 bg-purple-100 rounded-full"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"
            aria-hidden="true"
          >
        ...
        <p className="text-sm text-gray-500">How does your company compare? Learn how your company stacks up in
          the industry.
        </p>
      </div>
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        ...
        <p className="text-sm text-gray-500">Organize your customers to bring meaningful and comparative
          insights across your dashboards.
        </p>
      </div>
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        <div
          className="flex items-center justify-center w-8 h-8 mb-4 text-indigo-600 bg-indigo-100 rounded-full"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"
            aria-hidden="true"
          >
        ...
        <p className="text-sm text-gray-500">Improve your conversion rates by monitoring exactly what’s going on
      ...
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        ...
        <p className="text-sm text-gray-500">Personalized segmentation, rich customer profiles, manual
      ...
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        ...
        <p className="text-sm text-gray-500">Merge external data with your metrics for deeper insights in to
      ...
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        ...
        <p className="text-sm text-gray-500">Want your metrics in other services? Extend and integrate to our
      ...
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        ...
        <p className="text-sm text-gray-500">Send important updates from here to your team’s Support
          channels.
        </p>
      </div>
      <div className="drop-shadow-lg p-5 bg-white rounded-lg overflow-hidden">
        ...
        <p className="text-sm text-gray-500">Goals, Breakouts, Instant notifications, Comparisons, Annotations
          and Cohort Analysis!
        </p>
      </div>
    </div>
